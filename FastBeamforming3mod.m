function [X, Y, B] = FastBeamforming3mod(CSM, plane_distance, frequencies, ...
...
%
% This mod shapes FastBeamforming3 to be like Pieter Sijtsma's steering
% vector! I.e. a 4*pi is introduced to present real monopole expression and
% the beamform value is at a certain CONSTANT reference distance from a
% single scan point and not at the center of the array!! This is a more
% 'fair' way to present a beamform map. 

% To better understand this, consider two point sources of exact same 
% strength. If one is further away this one will be perceived at a lower 
% strength AT THE ARRAY CENTER than the other. Considering a CONSTANT 
% reference distance will result in the same strength, which is the actual
% case.
