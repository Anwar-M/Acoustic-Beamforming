function plot_settings(axisHandle, ...
                       xlab, ylab, titlab, ...
                       xlim, ylim, xtick, ytick, ...
...
set([hXLabel, hYLabel, hTitle], 'FontSize', 16);
...
if clr_bar(1)
    cb = colorbar('YTick', clr_bar(2):2:clr_bar(3));
    caxis([clr_bar(2) clr_bar(3)])
    title(cb, ctitlab, 'Fontsize', 16, 'FontName', 'CMU Serif', 'Interpreter', 'Latex');
%     ylabel(cb, ctitlab, 'Fontsize', 16, 'FontName', 'CMU Serif', 'Interpreter', 'Latex');
